...
Pod::Spec.new do |spec|
  ...
  spec.ios.vendored_frameworks = ['deploy/Frameworks/ArcXPVideo.xcframework', 'deploy/Frameworks/GoogleInteractiveMediaAds.xcframework', 'ArcXPVideo/Frameworks/OMSDK_Washpost.xcframework', 'ArcXPVideo/Frameworks/ProgrammaticAccessLibrary.xcframework']
  spec.tvos.vendored_frameworks = ['deploy/Frameworks/ArcXPVideo.xcframework', 'deploy/Frameworks/GoogleInteractiveMediaAds.xcframework', 'ArcXPVideo/Frameworks/ProgrammaticAccessLibrary.xcframework']
