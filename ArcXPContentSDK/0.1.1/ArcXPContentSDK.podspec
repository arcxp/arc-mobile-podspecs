...
Pod::Spec.new do |spec|
  ...
  # manually.
  spec.source                  = { :http => "https://arc-mobile-sdks.s3.amazonaws.com/home/iosContentSDK/version_/ArcXPContent.zip" }
  ...
  spec.ios.vendored_frameworks = ['ArcXPContent.xcframework']
