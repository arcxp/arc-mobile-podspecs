...
#
# Verifying:
# pod spec lint ArcXPContentSDK.podspec --private --allow-warnings --sources=wapopartners,trunk
#
# Releasing:
# pod repo push wapopartners ArcXPContentSDK.podspec --private --allow-warnings --sources=wapopartners,trunk
...
Pod::Spec.new do |spec|
  ...
  # manually.
  spec.source                  = { :http => "https://arc-mobile-sdks.s3.amazonaws.com/home/iosContentSDK/version_/deploy.zip" }
  ...
  spec.ios.vendored_frameworks = ['deploy/Frameworks/ArcXPContent.xcframework']
